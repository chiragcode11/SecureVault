    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          headers: {
            pinata_api_key: `
            76ecc1ff1cb2c4d71259`,
            pinata_secret_api_key: `
            
            cd21cf27d703733d915d57b4e0fb10200e2d13d1c5d9692e74174a3ca2c0188e`,
            "Content-Type": "multipart/form-data",
          },
        });
        const ImgHash = `coral-late-alligator-940.mypinata.cloud/ipfs/${resFile.data.IpfsHash}`;
